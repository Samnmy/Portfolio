  ...
  const experiences: ExperienceItem[] = [
    {
      type: 'work',
      period: '2022 - Present',
      title: t('experience.jobs.techCorp.title'),
      organization: 'TechCorp Inc.',
      description: t('experience.jobs.techCorp.description'),
      achievements: [
        t('experience.jobs.techCorp.achievements.0'),
        t('experience.jobs.techCorp.achievements.1'),
        t('experience.jobs.techCorp.achievements.2'),
      ],
    },
    {
      type: 'work',
      period: '2020 - 2022',
      title: t('experience.jobs.startupXYZ.title'),
      organization: 'StartupXYZ',
      description: t('experience.jobs.startupXYZ.description'),
      achievements: [
        t('experience.jobs.startupXYZ.achievements.0'),
        t('experience.jobs.startupXYZ.achievements.1'),
        t('experience.jobs.startupXYZ.achievements.2'),
      ],
    },
    {
      type: 'work',
      period: '2019 - 2020',
      title: t('experience.jobs.digitalAgency.title'),
      organization: 'Digital Agency',
      description: t('experience.jobs.digitalAgency.description'),
      achievements: [
        t('experience.jobs.digitalAgency.achievements.0'),
        t('experience.jobs.digitalAgency.achievements.1'),
        t('experience.jobs.digitalAgency.achievements.2'),
      ],
    },
    {
      type: 'education',
      period: '2015 - 2019',
      title: t('experience.jobs.university.title'),
      organization: t('experience.jobs.university.organization'),
      description: t('experience.jobs.university.description'),
      achievements: [
        t('experience.jobs.university.achievements.0'),
        t('experience.jobs.university.achievements.1'),
        t('experience.jobs.university.achievements.2'),
      ],
    },
  ];
